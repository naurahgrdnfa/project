...
<div class="content-page">
	<div class="content">
		...
		<div class="container-fluid">
			...
			<form action="<?php echo base_url('dashboard/update_pengguna/') . $pengguna[0]->user_id; ?>" enctype="multipart/form-data" method="post">
				<div class="container-fluid">
					<!-- Illustrations -->
							...
							<div class="text-center">
								...
								<form>
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" name="username" required="" value="<?php echo $pengguna[0]->username ?>">
										</div>
									</div>
									<div class="form-group row">
										<label style="text-align: left" class="col-sm-2 col-form-label">Password</label>
										<div class="col-sm-10">
											<input type="password" class="form-control" name="password" value="<?php echo $pengguna[0]->password ?>">
										</div>
									</div>
							</div>
							<div class="form-group row">
